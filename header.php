...
<head>
    ...
    <script src="https://kit.fontawesome.com/a95b154f50.js" crossorigin="anonymous"></script>
</head>
            ...
            <ul class="nav user-menu float-right">
                   <li class="nav-item dropdown has-arrow">
					...
					<div class="dropdown-menu">
                        <a class="dropdown-item" href="admin.php">Admin Setting</a>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="contact.php"><i class="fa-solid fa-address-book"></i> <span>Contact Information</span></a>
                        </li>
