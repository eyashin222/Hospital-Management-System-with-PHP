...
include('includes/connection.php');
    ...
    if(isset($_REQUEST['add-admin']))
    {
      ...
      $insert_query = mysqli_query($connection, "insert into tbl_admin set first_name='$first_name', last_name='$last_name', username='$username', emailid='$emailid', password='$pwd',  dob='$dob', employee_id='$employee_id', joining_date = '$joining_date', gender='$gender', address='$address', phone='$phone', role='$role', status='$status'");
                    ...
                    <div class="col-lg-8 offset-lg-2">
                       <form method="post">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="add-admin">Create Admin</button>
                            </div>
                        </form>
                    </div>
                </div>
