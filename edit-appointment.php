...
if(isset($_REQUEST['save-appointment']))
{
      ...
      $update_query = mysqli_query($connection, "update tbl_appointment set appointment_id='$appointment_id', first_name='$first_name', last_name='$last_name', department='$department', mobile='$mobile', e_mail='$e_mail', doctor='$doctor', date='$date',  time='$time', message='$message', status='$status' where id='$id'");
      if($update_query>0)
      {
