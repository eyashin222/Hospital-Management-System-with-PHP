...
$id = $_GET['id'];
$fetch_query = mysqli_query($connection, "select * from tbl_admin where id='$id'");
...
if(isset($_REQUEST['save-emp']))
{
      ...
      $update_query = mysqli_query($connection, "update tbl_admin set first_name='$first_name', last_name='$last_name', username='$username', emailid='$emailid', password='$pwd',  dob='$dob', employee_id='$employee_id', joining_date = '$joining_date', gender='$gender', address='$address', phone='$phone', role='$role', status='$status' where id='$id'");
      if($update_query>0)
      {
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8  text-right m-b-20">
                        <a href="admin.php" class="btn btn-primary btn-rounded float-right">Back</a>
                    </div>
                </div>
                <div class="row">
                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="status" id="admin_active" value="1" <?php if($row['status']==1) { echo 'checked' ; } ?>>
									<label class="form-check-label" for="employee_active">
									Active
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="status" id="admin_inactive" value="0" <?php if($row['status']==0) { echo 'checked' ; } ?>>
