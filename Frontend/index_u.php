						...
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									...
									<div class="button">
										<a href="appoinment_u.php" class="btn">Get Appointment</a>
										<a href="contact_u.php" class="btn primary">Conatct Now</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="single-schedule first">
								<div class="inner">
									...
									<div class="single-content">
										...
										<p>Lorem ipsum sit amet consectetur adipiscing elit. Vivamus et convallis erat in lacus convallis sodales.</p>
							...
							<div class="single-schedule middle">
								<div class="inner">
									...
									<div class="single-content">
										...
										<p>Lorem ipsum sit amet consectetur adipiscing elit. Vivamus et erat in lacus convallis convallis sodales.</p>
										<a href="#">LEARN MORE<i class="fa fa-long-arrow-right"></i></a>
									</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-12">
						<div class="content">
							...
							<h2><i class="fa fa-phone"></i> +880 1234 56789</h2>
							<h2><i class="fa fa-envelope"></i> support@gmail.com</h2>
